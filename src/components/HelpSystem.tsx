  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        columns: ["配置", "含义"],
        rows: [
          ["声音", "在“工具 → 鼓点库”上传、试听、下载和清理自定义鼓点；在项目属性中选择使用。鼓点可跨项目复用，但音频不会嵌入项目备份。"],
          ["相对音量", "歌曲会先按导出目标响度标准化，再叠加节拍。范围为 -40～+10 dB；默认 -10 dB 保留原有 0 dB 的基础节拍强度，当前 0 dB 在此基础上再突出 10 dB，+10 dB 则突出 20 dB。高增益触发真峰值保护时，歌曲与节拍会一起降低电平。关闭响度标准化时则以歌曲实测响度为基准。"],
          ["重拍", "按每 4、8 或 16 步为脚步分组，将每组第 1 步加强；“无重拍”让所有步骤相同。"],
          ["左右脚声道交替", "让相邻脚步略偏向左右不同声道，帮助区分左右脚；扬声器下可能不如耳机明显。"],
          ["试听", "播放约 6 秒独立节拍轨，并以当前导出响度作为歌曲参考，用于在混入歌曲前检查音色、相对音量、重拍和左右脚效果。"]
        ]
      }
    ]
  },
